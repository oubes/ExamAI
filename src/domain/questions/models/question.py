...
class Question(Base):
    ...
    type: Mapped[str] = mapped_column(__name_pos=Text, nullable=False)  # mcq / open / coding
    ...
    model_answer = relationship(argument="ModelAnswer", back_populates="question", uselist=False)
