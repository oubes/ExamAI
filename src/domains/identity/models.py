...
from sqlalchemy import DateTime, Text, Boolean, ForeignKey, Float, func
...
class UserSession(Base):
    ...
    last_seen_at: Mapped[DateTime | None] = mapped_column(__name_pos=DateTime(timezone=True), nullable=True)
