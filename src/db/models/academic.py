...
class Question(Base):
    ...
    __table_args__=(
        ...
        Index("idx_question_content_trgm","content",postgresql_using="gin",postgresql_ops={"content":"gin_trgm_ops"}),
    )
...
class QuestionOption(Base):
    ...
    __table_args__=(Index("idx_option_question_id","question_id"),
                    Index("idx_option_text_trgm","option_text",postgresql_using="gin",postgresql_ops={"option_text":"gin_trgm_ops"}))
...
class ModelAnswer(Base):
    ...
    __table_args__=(
        ...
        Index("idx_model_answer_content_trgm","content",postgresql_using="gin",postgresql_ops={"content":"gin_trgm_ops"}),
    )
